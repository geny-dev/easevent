...
@section('content')
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_audience">
                <thead>
                    <!--begin::Table row-->
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        <!-- <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_table_audience .form-check-input" value="1" />
                            </div>
                        </th> -->
    ...
    @push('scripts')
        ...
        $('document').ready(function() {
           // datatable
            var table = $('#kt_table_audience').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: "{{ route('user-management.audience.index') }}",
                columns: [
                    {
                        data: 'user',
                        name: 'name'
